...
- [🔥 SOTA 2024-2025: Vision Models](#-sota-2024-2025-vision-models)
- [🧠 SOTA 2024-2025: Mobile LLMs & Multimodal](#-sota-2024-2025-mobile-llms--multimodal)
- [⚡ Efficient Mobile Models](#-efficient-mobile-models)
...
|----------|-------------|----------|
| 🔷 [AppSheet](https://about.appsheet.com/home/) | Google's no-code platform | Data-driven apps, Quick prototypes |
| ⚡ [PowerApps](https://powerapps.microsoft.com/en-gb/) | Microsoft's low-code solution | Enterprise apps, Business workflows |
| 🎯 [FlutterFlow](https://flutterflow.io/) | Visual Flutter builder | Production-ready mobile apps |
| 🚀 [Adalo](https://www.adalo.com/) | No-code app builder | MVP, Startups |
...
- 🎓 [The Complete iOS App Development Bootcamp](https://www.appbrewery.co/p/ios-course-resources/)
- 📱 [Run Your App on iPhone or Simulator](https://www.youtube.com/watch?v=Fo1A36RsoCI)
- ⚙️ **Device Management**: iOS > Settings > General > VPN & Device Management

### 🔧 Advanced Integration

- 🔗 [How to consume C++ code in Swift](https://anuragajwani.medium.com/how-to-consume-c-code-in-swift-b4d64a04e989)
- ⚡ [NCNN-Swift](https://github.com/zhuzilin/ncnn-swift) - High-performance neural network inference
...
|-----------|-------------|-------------|
| [TensorFlow Lite](https://www.tensorflow.org/lite/android) | Google's mobile ML | ⚡⚡⚡⚡⚡ |
| [ML Kit](https://developers.google.com/ml-kit) | Ready-to-use ML APIs | ⚡⚡⚡⚡ |
| [MediaPipe](https://developers.google.com/mediapipe) | ML pipelines | ⚡⚡⚡⚡⚡ |
| [NCNN](https://github.com/Tencent/ncnn) | Tencent's framework | ⚡⚡⚡⚡⚡ |
| [MNN](https://github.com/alibaba/MNN) | Alibaba's framework | ⚡⚡⚡⚡⚡ |

---

## 🔥 SOTA 2024-2025: Vision Models

### 🎯 Object Detection - YOLO Series (Latest)

| Model | Year | Repository | Key Features |
|-------|------|------------|--------------|
| **YOLOv11** 🆕 | 2024 | [ultralytics/ultralytics](https://github.com/ultralytics/ultralytics) | Latest YOLO, improved accuracy & speed |
...
| **YOLO-World** 🌍 | 2024 | [AILab-CVC/YOLO-World](https://github.com/AILab-CVC/YOLO-World) | Open-vocabulary detection |
...
|-------|------|------------|------------|
| **SAM 2** 🆕 | 2024 | [facebookresearch/segment-anything-2](https://github.com/facebookresearch/segment-anything-2) | Video + Image segmentation |
| **Mobile-SAM** 📱 | 2024 | [ChaoningZhang/MobileSAM](https://github.com/ChaoningZhang/MobileSAM) | 60x faster than SAM, mobile-friendly |
| **FastSAM** ⚡ | 2023 | [CASIA-IVA-Lab/FastSAM](https://github.com/CASIA-IVA-Lab/FastSAM) | 50x faster segmentation |
...
## 🧠 SOTA 2024-2025: Mobile LLMs & Multimodal

### 🤖 On-Device Large Language Models

| Model | Year | Repository | Size | Key Features |
|-------|------|------------|------|--------------|
| **Gemma 2** 🆕 | 2024 | [google-deepmind/gemma](https://github.com/google-deepmind/gemma_pytorch) | 2B-27B | Google's open model, mobile-optimized |
| **Phi-3** 🆕 | 2024 | [microsoft/Phi-3](https://github.com/microsoft/Phi-3) | 3.8B | Microsoft's small language model |
| **Llama 3.2** 🦙 | 2024 | [meta-llama/llama3](https://github.com/meta-llama/llama-models) | 1B-3B | Meta's mobile-friendly LLM |
...
### 👁️ Vision-Language Models (Multimodal)

| Model | Year | Repository | Capabilities |
|-------|------|------------|--------------|
| **Florence-2** 🆕 | 2024 | [microsoft/Florence-2](https://huggingface.co/microsoft/Florence-2-large) | Unified vision tasks, prompting |
| **Qwen2-VL** 🆕 | 2024 | [QwenLM/Qwen2-VL](https://github.com/QwenLM/Qwen2-VL) | Multimodal understanding |
| **MobileVLM V2** 📱 | 2024 | [Meituan-AutoML/MobileVLM](https://github.com/Meituan-AutoML/MobileVLM) | Mobile vision-language model |
...
### 🎨 Vision Models & Feature Extraction
...
|-------|------|------------|-------------|
| **MobileNetV4** 🆕 | 2024 | [tensorflow/models](https://github.com/tensorflow/models/tree/master/research/slim/nets/mobilenet) | Universal mobile models |
| **EfficientViT** 🆕 | 2024 | [mit-han-lab/efficientvit](https://github.com/mit-han-lab/efficientvit) | MIT's efficient ViT |
| **FastViT** ⚡ | 2023 | [apple/ml-fastvit](https://github.com/apple/ml-fastvit) | Apple's fast vision transformer |
...
### 📦 Classic Detection Models

- 🎯 [YOLOv5](https://github.com/ultralytics/yolov5/) - Popular, production-ready
- 📚 [Ultralytics Docs](https://docs.ultralytics.com/) - Comprehensive documentation
- 🔬 [Roboflow YOLOv5 Tutorial](https://colab.research.google.com/github/roboflow-ai/yolov5-custom-training-tutorial/blob/main/yolov5-custom-training.ipynb)

### 🏷️ Annotation Tools & Converters
...
- 📖 [Imantics Documentation](https://imantics.readthedocs.io/en/latest/api.html#polygons-object)
- 💬 [COCO API Polygon Discussion](https://github.com/cocodataset/cocoapi/issues/39)
...
| **MediaPipe** 🆕 | iOS/Android/Web | 2024 | Real-time ML pipelines |
...
- 🤗 [Hugging Face](https://huggingface.co/models) - Largest ML model hub
- 🔥 [PyTorch Hub](https://pytorch.org/hub/) - PyTorch models
- 🧠 [TensorFlow Hub](https://www.tensorflow.org/hub) - TF models
- 🍎 [Core ML Models](https://developer.apple.com/machine-learning/models/) - Apple's model zoo
- 🔬 [ONNX Model Zoo](https://github.com/onnx/models) - ONNX format models

### 📚 Learning Resources

- 📖 [Made With ML](https://madewithml.com/) - ML production course
- 🎓 [Fast.ai](https://www.fast.ai/) - Practical deep learning
- 🚀 [Papers With Code](https://paperswithcode.com/) - Latest research + code
- 🔬 [Awesome Mobile AI](https://github.com/topics/mobile-ai) - Curated list
...
- 🎯 [Awesome-Mobile-AI](https://github.com/yourusername/awesome-mobile-ai) - Curated awesome list
- 🔥 [Mobile-AI-Benchmark](https://github.com/yourusername/mobile-ai-benchmark) - Benchmarking suite
- 📱 [AI-Camera-App](https://github.com/yourusername/ai-camera-app) - Production-ready app
